...
<head>
    ...
    <title>Home 2 :: theBell - Multipurpose eCommerce Bootstrap 4 Template</title>
...
<header id="header-area" class="headerTwo">
                        ...
                        <nav id="site-settings">
                            <ul class="nav justify-content-center justify-content-md-end">
                                <li class="dropdown-show">
                                    <a href="my-account.html" class="arrow-toggle">Tài khoản của tôi</a>
                                ...
                                <li class="dropdown-show"><a href="#" class="arrow-toggle"><img src="assets/images/icons/flag/en.png" alt="English"/> English</a>
                                    <ul class="dropdown-nav">
                                        <li><a href="#"><img src="assets/images/icons/flag/de.png" alt="German"/>German</a></li>
                                        <li><a href="#"><img src="assets/images/icons/flag/bd.png" alt="Bengali"/> Bengali</a></li>
                                        <li><a href="#"><img src="assets/images/icons/flag/fr.png" alt="France"/>France</a></li>
                                    </ul>
                                </li>
    ...
    <div class="header-bottom-area" id="fixheader">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-7 m-auto d-none d-lg-block">
                    <div id="navigation-area-wrap" class="text-center">
                        <nav class="mainmenu">
                            <ul id="main-navbar" class="clearfix">
                                    ...
                                    <ul class="mega-menu-wrap dropdown-nav">
                                        ...
                                        <li class="mega-menu-item"><a href="single-product.html"
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="detail.html">Single Product Sticky
                                                        Left</a></li>
                                ...
                                <li class="dropdown-show">
                                    <a href="#" class="arrow-toggle">Pages</a>
                                    <ul class="dropdown-nav">
                                ...
                                <li class="dropdown-show">
                                    <a href="#" class="arrow-toggle">Tin tức</a>
                                    <ul class="dropdown-nav">
                            ...
                            <div class="minicart-content">
                                <div class="mini-cart-body">
                                    ...
                                    <div class="single-cart-item d-flex">
                                        ...
                                        <a href="single-product.html" class="remove-icon">
                                            <i class="fa fa-trash-o"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="mini-cart-footer text-center">
                                    <a href="cart.html" class="btn btn-transparent btn-small mr-3">Xem giỏ hàng</a>
                                    <a href="checkout.html" class="btn btn-transparent btn-small">Thanh toán</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            <div class="search-box-wrapper">
                <form action="#" method="POST" class="search-form-area">
                    <input type="search" class="form-control" name="search" id="search" placeholder="Tìm kiếm">
                    <button type="submit" class="btn btn-brand btn-search">
                        <i class="fa fa-search"></i>
                    </button>
                </form>
            </div>
